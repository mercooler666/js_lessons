...
// Условие:
// Сохрани имя ученика в переменную studentName, пусть это будет "Lena".

// Сохрани три оценки: score1 = 7, score2 = 9, score3 = 10.

// Вычисли сумму и среднее арифметическое.

// Выведи в консоль фразу:

// Копировать
// Редактировать
// Ученик Lena получил среднюю оценку: 8.67
// 🔸 Среднее округли до двух знаков после запятой.
// 🔸 Используй шаблонные строки (`текст ${переменная}`).
// 🔸 Используй toFixed(2) для округления.
